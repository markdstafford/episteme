  ...
  return (
    <div className="rounded-(--radius-xl) border border-(--color-border-default) focus-within:border-(--color-accent) focus-within:shadow-[0_0_0_2px_color-mix(in_oklch,var(--color-accent)_25%,transparent)]">
      <textarea
        ...
        data-ui-input
        className="w-full resize-none bg-transparent border-none outline-none px-3 pt-3 text-[length:var(--font-size-ui-base)] text-(--color-text-primary) overflow-y-auto disabled:opacity-50"
      />
