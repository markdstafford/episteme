...
-- (NULL until enhancement completes). use_enhanced tracks which is selected.
...
queue_comment(id: str, thread_id: str | null, doc_id: str | null,
              ...
              body_original: str, body_enhanced: str | null, use_enhanced: bool,
...
toggle_queued_body(id: str) → ()
  Flip use_enhanced. Only meaningful once body_enhanced is populated.
