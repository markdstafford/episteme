...
See `.eng-docs/wiki/design-system.md` for the canonical design system reference — all color tokens, type scales, spacing, component patterns, and the Tailwind v4 encoding guide.
